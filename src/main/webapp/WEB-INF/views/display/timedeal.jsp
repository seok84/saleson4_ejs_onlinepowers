...
<layout:default>
    <div class="item-list-page display-page">
        <h1 class="title-h1">타임세일</h1>
        <div class="display-ad pc">
            <img src="/static/content/image/item/timesale_banner.png" alt="banner-pc">
        </div>
        <div class="display-ad mobile">
            <img src="/static/content/image/item/timesale_banner_mo.png" alt="banner-mobile">
        </div>
        ...
        <c:set var="itemListClass" value="item-list-3 timedeal-list" scope="request"/>

        <c:set var="itemListName" value="타임세일" scope="request"/>
        <c:set var="itemListId" value="display-timedeal" scope="request"/>
        <c:set var="itemListAnalyticsFlag" value="true" scope="request"/>

        <c:set var="displaySpotFlag" value="true" scope="request"/>
